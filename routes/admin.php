...
Route::prefix('admin-home')->middleware(['setlang:backend'])->group(function () {
    ...
    Route::post('/member-status', 'AdminDashboardController@member_status')->name('admin.member_status');
    Route::post('/member-update', 'AdminDashboardController@updateMemberDetails')->name('admin.member.update');
    Route::post('/member-change-password', 'AdminDashboardController@member_password_change')->name('admin.member.change-password');
    Route::post('/member-delete/{id}', 'AdminDashboardController@member_delete')->name('admin.member_delete');
...
==============================================*/
    ...
    Route::prefix('frontend/user')->middleware(['adminPermissionCheck:Users Manage'])->group(function () {
        ...
        Route::get('/user/download-pic/{id}',  'FrontendUserManageController@downloadProfilePic')->name('admin.frontend.user.download-pic');
