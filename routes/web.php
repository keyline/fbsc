...
Route::group(['middleware' => ['setlang:frontend', 'globalVariable', 'maintains_mode']], function () {
    ...
    Route::get('/member-register','FrontendController@member_register')->name('member_register');
    Route::post('/member-register','FrontendController@create_member')->name('member_create');
    Route::get('/member-add-business/{memberId}','FrontendController@add_member_business')->name('add_member_business');
    Route::post('/member-store-business','FrontendController@store_member_business')->name('store_member_business');
    Route::post('/upload-cropped-image', 'FrontendController@uploadCroppedImage')->name('upload.cropped.image');
    Route::post('/upload-cropped-profile', 'FrontendController@uploadCroppedProfile')->name('upload.cropped.profile');
    Route::post('/check-username-availability', 'FrontendController@checkUsernameAvailability');
...
Route::prefix('user-home')->middleware(['userEmailVerify', 'setlang:frontend', 'globalVariable', 'maintains_mode'])->group(function () {
   // Route::get('/', 'UserDashboardController@user_index')->name('user.home');
    Route::get('/all-ads', 'AdController@index')->name('all-ads');
    Route::get('/create-ads', 'AdController@create')->name('create-ads');
    Route::get('/edit-ads/{id}', 'AdController@edit')->name('edit-ads');
    Route::post('/store-ads', 'AdController@store')->name('store-ads');
    Route::post('/ads-update', 'AdController@update_ads')->name('update-ads');
    Route::delete('/ads-delete/{id}', 'AdController@deleteAds')->name('delete-ads');
    Route::get('/', 'UserDashboardController@edit_profile')->name('user.home');
    Route::get('/profile-pic', 'UserDashboardController@edit_profile_pic')->name('user.home.profile.pic');
    Route::get('/profile-cover-pic', 'UserDashboardController@edit_profile_cover')->name('user.home.profile.cover.pic');
    Route::post('/profile-pic-update', 'UserDashboardController@profile_pic')->name('user.home.profile.pic.update');
    Route::post('/profile-cover-pic-update', 'UserDashboardController@profile_cover_pic')->name('user.home.profile.cover.pic.update');
    ...
    Route::get('/reset-password', 'UserDashboardController@inital_password')->name('user.inital.password');
    Route::post('/member-password-change', 'UserDashboardController@member_password_change')->name('member.password.change');
    ...
    Route::get('/business', 'UserDashboardController@index_business')->name('user.business');
    Route::get('/members', 'UserDashboardController@index_Members')->name('user.members');
    Route::get('/filter-by-alphabet', 'UserDashboardController@filterByAlphabet');
    Route::get('/search-by-name', 'UserDashboardController@searchByName');
    Route::get('/offers', 'UserDashboardController@index_Offers')->name('user.offers');
    Route::post('/business-store', 'UserDashboardController@create_business')->name('business.store');
    Route::put('/business-update/{id}', 'UserDashboardController@update_business')->name('business.update');
    Route::delete('/business-delete/{id}', 'UserDashboardController@deleteBusiness')->name('business.delete');
    Route::get('/search', 'UserDashboardController@ajaxSearch')->name('business.ajaxSearch');
    Route::get('/get-business-data/{id}','UserDashboardController@getBusinessData')->name('user.getBusinessData');
    Route::get('/get-user-Profile/{id}','UserDashboardController@getUserProfile')->name('user.userProfile');
});

/*----------------------------------
    USER BUSINESS DASHBOARD
-----------------------------------*/
Route::prefix('user-business')->middleware(['userEmailVerify', 'setlang:frontend', 'globalVariable', 'maintains_mode'])->group(function () {
  //Route::get('/chat', 'ChatController@index');
    ...
    Route::get('/fetch-old-messages', 'ChatController@getOldMessages');
     Route::post('/mark-messages-as-read/{user}', 'ChatController@markMessagesAsRead')->name('mark-messages-as-read');
});
