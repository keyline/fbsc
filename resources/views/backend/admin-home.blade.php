                        ...
                        <div class="col-md-3 mt-5 mb-3">
                            <div class="card text-dark mb-3">
                                <div class="dsh-box-style">
                                    ...
                                    <div class="content">
                                        <span class="total">{{ $total_users }}</span>
                                        <h4 class="title">{{ __('Total Users') }}</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3 mt-md-5 mb-3">
                            <div class="card text-dark  mb-3">
                                <div class="dsh-box-style">
                                    ...
                                    <div class="content">
                                        <span class="total">{{ $total_member }}</span>
                                        <h4 class="title">{{ __('Members Register') }}</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3 mt-md-5 mb-3">
                            <div class="card text-dark  mb-3">
                                <div class="dsh-box-style">
                                    ...
                                    <div class="content">
                                        <span class="total">{{ $total_business }}</span>
                                        <h4 class="title">{{ __('Total Business') }}</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <tr>
                                            ...
                                            @if ($committees)
                                                @foreach ($committees as $committee)
                                                    {{ $committee }}
                                                    @if (!$loop->last)
                                                        {{-- Add a comma after each committee except the last one --}}
                                                        ,
                                                    @endif
                                                @endforeach
                                            @endif
                                            </td>
                                            <td>{{ $data->member_category }}</td>
                                            <td>
                                            ...
                                            <td>
                                                <a href="#" data-toggle="modal" data-target="#member_edit_modal"
                                                    ...
                                                    data-whatsapp="{{ $data->whatsapp }}" data-state="{{ $data->state }}"
                                                    data-city="{{ $data->city }}" data-zipcode="{{ $data->zipcode }}"
                                                    data-country="{{ $data->country }}" data-about="{{ $data->about }}"
                                                    data-address="{{ $data->address }}"
                                                    data-member_category="{{ $data->member_category }}"
                                                ...
                                                <x-delete-popover :url="route('admin.member_delete', $data->id)" />
                                                
                                                @if (check_page_permission_by_string('Manage Members Password'))
                                                    <a href="#" data-id="{{ $data->id }}"
                                                        data-whatsapp="{{ $data->whatsapp }}"
                                                        data-username="{{ $data->username }}" data-toggle="modal"
                                            ...
                                            <td>
                                                @if ($data->status == 'pending')
                                                    <form action="{{ route('admin.member_status') }}" method="post">
                                                        @csrf
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title">{{ __('Member Details Edit') }}</h5>
                            <button type="button" class="close" data-dismiss="modal"><span>×</span></button>
                        </div>
                        <form action="{{ route('admin.member.update') }}" id="user_edit_modal_form" method="post"
        ...
        <div class="modal fade" id="user_change_password_modal" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        @endif
                        <form action="{{ route('admin.member.change-password') }}" id="user_password_change_modal_form"
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    <label for="password">{{ __('Username') }}</label>
                                ...
                                <div class="form-group">
                                    <button type="button" class="btn btn-secondary"
                                        onclick="generatePassword()">{{ __('Generate Password') }}</button>
                                    <button type="button" class="btn btn-primary"
                                        onclick="sendPasswordViaWhatsApp()">{{ __('Send Password via WhatsApp') }}</button>
                                </div>
