                                        ...
                                        <table id="all_user_table" class="text-center">
                                            ...
                                            @foreach($all_user as $data)
                                                <tr>
                                                    ...
                                                    <td>{{$data->username}}</td>
                                                    <td>
                                                        @if (!empty($data->profile_pic) && file_exists(public_path($data->profile_pic)))
                                                            <img width="100" src="{{ asset($data->profile_pic) }}" alt="">
                                                            <br>
                                                            <a href="{{ route('admin.frontend.user.download-pic', $data->id) }}" class="btn btn-primary btn-sm">Download</a>
                                                            @else
