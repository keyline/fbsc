    ...
    <div class="dashboard-form-wrapper">
        ...
        <form action="{{route('user.profile.update')}}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="profession" name="profession" value="{{$user_details->profession}}">
            </div>
            <div class="form-group">
                <label for="about">{{__('About')}}</label>
                <textarea class="form-control" id="about" maxlength="300" name="about">{{$user_details->about}}</textarea>
            </div>
            <div class="form-group">
