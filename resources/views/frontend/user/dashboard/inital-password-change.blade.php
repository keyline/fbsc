...
@section('content')
    <section class="login-page-wrapper">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="user-dashboard-wrapper justify-content-center">
                                ...
                                <div class="dashboard-form-wrapper">
                                    ...
                                    <form action="{{ route('member.password.change') }}" method="post"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="password" class="form-control passwordField" id="old_password"
                                                name="old_password" placeholder="{{ __('Old Password') }}">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <button type="submit"
                                            class="submit-btn dash-btn width-200">{{ __('Save changes') }}</button>
                                    </form>
                                </div>
                            </div>
                        </div>
