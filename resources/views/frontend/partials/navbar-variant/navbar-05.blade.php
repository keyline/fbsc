                    ...
                    <div class="right-content-wrap">
                        <ul>
                            ...
                            @if(!empty(filter_static_option_value('navbar_button',$global_static_field_data)))
                                <li>
                                    @php
                                        $custom_url = filter_static_option_value('navbar_button_custom_url_status',$global_static_field_data) ? get_static_option('navbar_button_custom_url') : route('frontend.contact');
                                    @endphp
