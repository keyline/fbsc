...
class FrontendUserManageController extends Controller
{
    ...
    public function all_user()
    {
     ...
     public function downloadProfilePic($id)
{
    // Find the user by ID
    ...
    // Create a custom filename with the user's name
    $fileName = $user->name . '-profile-pic.' . pathinfo($profilePicPath, PATHINFO_EXTENSION);

    // Return the file as a response for download
    return response()->download($profilePicPath, $fileName);
}
