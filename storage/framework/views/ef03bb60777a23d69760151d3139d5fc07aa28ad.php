                                        ...
                                        <table id="all_user_table" class="text-center">
                                            ...
                                            <?php $__currentLoopData = $all_user; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php if(!empty($data->profile_pic) && file_exists(public_path($data->profile_pic))): ?>
                                                            <img width="100" src="<?php echo e(asset($data->profile_pic)); ?>" alt="">
                                                            <br>
                                                            <a href="<?php echo e(route('admin.frontend.user.download-pic', $data->id)); ?>" class="btn btn-primary btn-sm">Download</a>
                                                            <?php else: ?>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u235913067/domains/fbsc.in/public_html/resources/views/backend/frontend-user/all-user.blade.php ENDPATH**/ ?>