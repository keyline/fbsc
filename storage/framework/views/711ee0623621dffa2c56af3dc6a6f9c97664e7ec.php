...
<body
    class="<?php echo e(request()->path()); ?> home_variant_<?php echo e($home_page_variant); ?> <?php echo e(filter_static_option_value('item_license_status', $global_static_field_data)); ?> apps_key_<?php echo e(filter_static_option_value('site_script_unique_key', $global_static_field_data)); ?> ">
    ...
    <?php endif; ?>
<?php /**PATH /home/fbscin/public_html/resources/views/frontend/partials/header.blade.php ENDPATH**/ ?>